 ...
 * @endcode
 */
$settings['hash_salt'] = 'k4l4wmBpdg5-fm3qd3NQzD8PwXSm615a20Z6qw0-fb2j2sfWDcmDWNnDFsUzi01um2aiI5OAoA';
...
$config['nodejs.config']['nodejs']['host'] = 'pendeedus.ub';
$config['nodejs.config']['nodejs']['port'] = 8080;
$config['nodejs.config']['client']['scheme'] = 'http';
$config['nodejs.config']['client']['host'] = 'pendeedus.ub';
$config['nodejs.config']['client']['port'] = 8080;

$config['nodejs.config']['socket_io']['path'] = 'http://pendeedus.ub:8080/socket.io/socket.io.js';
