...
namespace Drupal\pd_core\Plugin\Commerce\PaymentGateway;
...
/**
 * Provides the credit card payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "pendeedus_credit_card",
 *   label = "Credit card",
 *   display_label = "Credit card",
 *   forms = {
 *     "add-payment-method" = "Drupal\pd_core\PluginForm\Onsite\PaymentMethodAddForm",
 *     "edit-payment-method" = "Drupal\pd_core\PluginForm\PaymentMethodEditForm",
 *   },
 ...
 */
final class CreditCardPaymentGateway extends OnsitePaymentGatewayBase implements OnsitePaymentGatewayInterface {
